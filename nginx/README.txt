...
1. Make sure the 3 API containers are spun up. Follow the docker/README.txt file first.
...
4. Now the nginx server is set up to load balance the incoming requests to the 3 API docker
   ...
   And nginx will dish the request out to one of the 3 API containers.
